      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className="md:w-1/2 mb-10 md:mb-0 md:pr-10 text-center md:text-left">
            <h1 className="text-4xl md:text-5xl font-dynapuff text-black mb-6">
              We Have a Destination<br />for Every Budget
            </h1>
            <p className="text-xl text-gray-600 mb-10 max-w-xl mx-auto md:mx-0">
              Discover amazing destinations without breaking the bank. 
              Get personalized budget estimates and plan your perfect adventure 
              with our AI-powered travel assistant.
            </p>
          ...
          {/* Image - centered with reduced height on mobile */}
          <div className="md:w-1/2 flex justify-center mt-8 md:mt-0">
            <img 
              src="/heroimage.png" 
              alt="Travel Adventure" 
              className="w-full max-w-[510px] h-auto max-h-[300px] md:max-h-[391px] object-contain"
              width={510}
              height={391}
            />
          </div>
